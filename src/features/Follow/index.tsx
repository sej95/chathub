...
import { SiDiscord, SiGithub, SiMedium, SiReact } from '@icons-pack/react-simple-icons';
  ...
  return (
    <Flexbox gap={8} horizontal>
      ...
      <Link href={X} rel="noreferrer" target={'_blank'}>
        <ActionIcon className={styles.icon} icon={SiReact as any} title={t('follow', { name: 'X' })} />
      </Link>
